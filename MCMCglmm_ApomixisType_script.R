sink(file = "MCMCglmm_ApomixisType_script.txt")
...
Online_v7_mean$Apomixis_type <- factor(as.character(Online_v7_mean$Apomixis_type), levels = c("Aposporous", "Diplosporous", "Apo-diplosporous", "Uncertain", "Sexual"))
...
ext_mThre_aposporous1 <- MCMCglmm(Repr_mode_summ ~ Average.elevation + Ploidy_summ + Flowering.time..initiation.month.,
                       ginverse = list(animal = invJanTree_CC__tips_aposporous$Ainv),
...
ext_mThre_diplosporous1 <- MCMCglmm(Repr_mode_summ ~ Average.elevation + Ploidy_summ + Flowering.time..initiation.month.,
                                  ginverse = list(animal = invJanTree_CC__tips_diplosporous$Ainv),
                                  random = ~ animal, verbose = F,
