sink(file = "MCMCglmm_ApomixisType_StrictlyAlps_script_diplosporous.txt")

##### HELLO! This is the beginning of the MCMCglmm_ApomixisType_script.R ! ##### 
setwd("C:/Users/lucap/Documents/R/Apomixis_MCMCglmm_ApomixisType_StrictlyAlps")
print(getwd())
...
##### Load data #####
Online_v7_StrictlyAlps_mean_ApomixisType <- read.csv(file = "Online_v7_StrictlyAlps_mean_ApomixisType.csv", header = T)[,-1]
str(Online_v7_StrictlyAlps_mean_ApomixisType)
Online_v7_StrictlyAlps_mean_ApomixisType$Repr_mode <- factor(Online_v7_StrictlyAlps_mean_ApomixisType$Repr_mode, levels = c("Sexual", "Apomictic"))
Online_v7_StrictlyAlps_mean_ApomixisType$Repr_mode_summ <- factor(Online_v7_StrictlyAlps_mean_ApomixisType$Repr_mode_summ, levels = c("Sexual", "Mixed", "Apomictic"))
Online_v7_StrictlyAlps_mean_ApomixisType$Ploidy_summ <- factor(Online_v7_StrictlyAlps_mean_ApomixisType$Embryo.Ploidy.summ, levels = c("2x", "3x", "4x", "Poly"))
Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type <- factor(as.character(Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type), levels = c("Aposporous", "Diplosporous", "Apo-diplosporous", "Uncertain", "Sexual"))
Online_v7_StrictlyAlps_mean_ApomixisType[!complete.cases(Online_v7_StrictlyAlps_mean_ApomixisType), ] # no missing values
nrow(Online_v7_StrictlyAlps_mean_ApomixisType)

colnames(Online_v7_StrictlyAlps_mean_ApomixisType)[2] <- "animal" # this is needed because of a MCMCglmm quirkiness

##### Load the tree #####
library(ape)
JanTree4_StrictlyAlps_online <- read.tree(file = "JanTree4_StrictlyAlps_online.tre")

setdiff(JanTree4_StrictlyAlps_online$tip.label, Online_v7_StrictlyAlps_mean_ApomixisType$animal)
setdiff(Online_v7_StrictlyAlps_mean_ApomixisType$animal, JanTree4_StrictlyAlps_online$tip.label)
...
# library(ape)
# library(phytools)
# setdiff(JanTree4_StrictlyAlps_online$tip.label, unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Aposporous", "Sexual"), "animal"]))
# drop.tip(JanTree4_StrictlyAlps_online, 
#          setdiff(JanTree4_StrictlyAlps_online$tip.label, 
#                  unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Aposporous", "Sexual"), "animal"])
#          )
# )
# 
# facetoface_apo <- cophylo(JanTree4_StrictlyAlps_online, 
#                           drop.tip(JanTree4_StrictlyAlps_online, 
#                                    setdiff(JanTree4_StrictlyAlps_online$tip.label, 
#                                            unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Aposporous", "Sexual"), "animal"])
#                                    )
...
# ###
# Online_v7_StrictlyAlps_mean_ApomixisType_aposporous <- Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Aposporous", "Sexual"), ]
# str(Online_v7_StrictlyAlps_mean_ApomixisType_aposporous)
# 
# JanTree4_StrictlyAlps_online_aposporous <- drop.tip(JanTree4_StrictlyAlps_online, 
#                                                     setdiff(JanTree4_StrictlyAlps_online$tip.label, 
#                                                             unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Aposporous", "Sexual"), "animal"])))
# JanTree4_StrictlyAlps_online_aposporous
# 
# ##### MCMC chains #####
# library(MCMCglmm)
# 
# ### Phylogeny black magic
# invJanTree_CC_aposporous <- inverseA(JanTree4_StrictlyAlps_online_aposporous, nodes = "ALL", scale = TRUE)
# invJanTree_CC_tips_aposporous <- inverseA(JanTree4_StrictlyAlps_online_aposporous, nodes = "TIPS", scale = TRUE)
# 
...
#                                         verbose = F, data = Online_v7_StrictlyAlps_mean_ApomixisType_aposporous,
...
#                                   data = Online_v7_StrictlyAlps_mean_ApomixisType_aposporous,
#                                   family = "threshold", trunc = T,
...
setdiff(JanTree4_StrictlyAlps_online$tip.label, unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Diplosporous", "Sexual"), "animal"]))
ape::drop.tip(JanTree4_StrictlyAlps_online,
              setdiff(JanTree4_StrictlyAlps_online$tip.label,
                      unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Diplosporous", "Sexual"), "animal"])
              )
)

facetoface_diplo <- cophylo(JanTree4_StrictlyAlps_online,
                            drop.tip(JanTree4_StrictlyAlps_online,
                                     setdiff(JanTree4_StrictlyAlps_online$tip.label,
                                             unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Diplosporous", "Sexual"), "animal"])
                                     )
...
###
Online_v7_StrictlyAlps_mean_ApomixisType_diplosporous <- Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Diplosporous", "Sexual"), ]
str(Online_v7_StrictlyAlps_mean_ApomixisType_diplosporous)

JanTree4_StrictlyAlps_online_diplosporous <- drop.tip(JanTree4_StrictlyAlps_online,
                                            setdiff(JanTree4_StrictlyAlps_online$tip.label,
                                                    unique(Online_v7_StrictlyAlps_mean_ApomixisType[Online_v7_StrictlyAlps_mean_ApomixisType$Apomixis_type %in% c("Diplosporous", "Sexual"), "animal"])))
JanTree4_StrictlyAlps_online_diplosporous

##### MCMC chains #####
library(MCMCglmm)

### Phylogeny black magic
invJanTree_CC_diplosporous <- inverseA(JanTree4_StrictlyAlps_online_diplosporous, nodes = "ALL", scale = TRUE)
invJanTree_CC_tips_diplosporous <- inverseA(JanTree4_StrictlyAlps_online_diplosporous, nodes = "TIPS", scale = TRUE)
...
ext_mThre_diplosporous1_noPhy <- MCMCglmm(Repr_mode_summ ~ Average.elevation + Ploidy_summ + Flowering.time..initiation.month.,
                                          verbose = F, data = Online_v7_StrictlyAlps_mean_ApomixisType_diplosporous,
                                          family = "threshold", trunc = T,
                                          prior = prior_V1fix1,
                                          nitt = 10^6, thin = 500, burnin = 25000)
...
ext_mThre_diplosporous1 <- MCMCglmm(Repr_mode_summ ~ Average.elevation + Ploidy_summ + Flowering.time..initiation.month.,
                                    ...
                                    random = ~ animal, verbose = F,
                                    data = Online_v7_StrictlyAlps_mean_ApomixisType_diplosporous,
                                    family = "threshold", trunc = T,
                                    prior = prior_nu1000_1,
                                    nitt = 10^6, thin = 500, burnin = 25000)
...
##### GOODBYE! This is the end of the MCMCglmm_ApomixisType_StrictlyAlps_diplosposrous_script.R ! ##### 
